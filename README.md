...
- [PDF du cours à récupérer](https://drive.google.com/file/d/1OwDym36Jwy9CnIGEDOorX7y-svcw2hIU/view?usp=sharing)
...
## Lancement des tests dans cette formation

- Unitaires avec la commande : `npm run test:u`
- Intégration : `npm run test:i`
- E2E : `npm run test:e`